...
<header class="text-gray-900 relative">
        <!-- header nav -->
       <nav class="mainNav z-50 p-5 bg-opacity-70 sticky top-0 duration-500 md:w-[700px] mx-auto lg:!w-auto lg:py-2">
            <div class="nav flex justify-between items-center sm:mx-auto">
       ...
       <section class="mt-28 px-4">
            ...
            <p class="text-md text-center font-medium mt-6 text-gray-500 md:w-[700px] sm:mx-auto">
                ...
                <div class="swiper w-full md:w-2/3">
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48" class="w-20 h-20 sm:w-28 sm:h-28">
                      ...
                      <div class="swiper-slide">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 40 40" class="w-20 h-20 sm:w-28 sm:h-28">
