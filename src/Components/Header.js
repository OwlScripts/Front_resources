 ...
 <header class="text-gray-900 relative">
        <!-- header nav -->
       <nav class="p-5 bg-slate-50 bg-opacity-70 sticky top-0">
            <div class="nav flex justify-between items-center md:w-[700px] sm:mx-auto">
                <a href="." class="text-2xl font-semibold">Owl Scripts</a>
                <!-- desktop size's option menu -->
                <div></div>
                <!-- mode switch and ham menu -->
                <div class="flex items-center flex-row-reverse gap-3 hm:gap-0">
                    <div class="relative" x-data="{open : false}">
                        <div @click="open = !open" class="flex flex-col w-7 gap-1 cursor-pointer hm:hidden">
                        ...
                        <aside x-show="open" class="absolute right-0 top-12 hm:hidden">
       ...
       <section class="mt-28 px-4">
            <h1 class="text-3xl text-center md:w-[700px] sm:mx-auto sm:text-4xl md:text-5xl">
                <strong>Tailwind CSS Template for Crypto, ICO and Web3</strong>
            </h1>
            <p class="text-lg text-center font-medium mt-6 text-gray-500 md:w-[700px] sm:mx-auto">
