 ...
 <!-- header nav -->
<nav class="flex justify-between items-center p-5 bg-slate-50 bg-opacity-70">
     ...
     <div class="flex items-center flex-row-reverse gap-3">
         <div>
             <div x-data="{open : false}" @click="open = !open" class="flex flex-col w-7 gap-1 cursor-pointer">
...
<section class="mt-16 px-4">
     ...
     <p class="text-xl text-center mt-6 text-gray-500">
