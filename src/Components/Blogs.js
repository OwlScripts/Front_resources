...
<section id="Blogs" class="my-12">
    <div class="blogs-header-desc flex flex-col  justify-center items-center ">
        ...
        <p
            class="flex justify-center drop-shadow-xl hover:origin-top-left  bg-gradient-to-b from-slate-500/20 to-white  transition-all  items-center gap-4 hero-subtitle-gradient px-4 py-2 rounded-full">
            <svg class="fill-purple-500 z-10" width="17" height="16" viewBox="0 0 17 16" fill="none"
            ...
            <span
                class="blog-hero-sub inline-block text-transparent bg-clip-text bg-gradient-to-r from-indigo-500  to-indigo-900 ">
                Read Our Latest Blogs </span>
        </p>
    ...
    <div class="blog-posts-wrapper grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-8 xl:px-44 mt-12 gap-8">
        ...
        <a href="#" class="item group mt-6 xl:mt-0   flex flex-col justify-start items-start overflow-hidden">
            ...
            <div class="blogs-cat flex gap-3 my-4 ">
                <p
                    class="text-indigo-700 border cursor-default   border-indigo-700  px-3  rounded-xl hover:bg-purple-500 hover:border-purple-100  hover:text-white transition-colors duration-200 ">
                    Design</p>
                <p
                    class="text-indigo-700 border cursor-default border-indigo-700  px-3  rounded-xl hover:bg-purple-500 hover:border-purple-100  hover:text-white transition-colors duration-200 ">
                    Engineering</p>
        ...
        <!-- item 3 -->
        <a href="#"
            class="item group mt-6 xl:mt-0   flex flex-col justify-start items-start overflow-hidden  md:hidden lg:flex">
            <div class="img-wrapper overflow-hidden rounded-lg">
    ...
    <div class="seemore-section flex justify-center items-center mt-12  ">
        <a href="#" class="my-btn rounded-full px-6 py-2 outline  outline-2 outline-purple-800  hover:outline hover:outline-2 hover:outline-purple-500 text-black hover:text-indigo-950  hover:outline-offset-2 duration-200 delay-75   font-semibold  bg-gradient-to-r from-indigo-500  to-indigo-900    "> Show More ...</a>
    </div>
</section>
`;
